...
INSERT INTO [Sbyt].[Пользователи]
     ...
     VALUES
           ('SuperAdmin','','Пшиков','Игорь','Евгеньевич','Отдел информационного сопровождения'),
...
INSERT INTO [Sbyt].[Договор]
           ([Номер],[Плательщик],[Грузополучатель],[Начало_договора],[Тип_договора],[Категория_ИД],[Отрасль_ИД],[Бюджет_ИД],[Примечение])
     VALUES
...
INSERT INTO [Sbyt].[Лицевые_счета]
     ...
     VALUES
           (10000001,'г. Саранск, ул Красная, д 13','подвальное помещение'),
		   (10000002,'г. Саранск, ул Зеленая, д 15 пом. 4',''),
		   (10000003,'г. Саранск, ул Ленина , д 114 пом. 312','кабинет приемной'),
		   (10000004,'г. Саранск, ул Ленина , д 114 пом. 311','')
